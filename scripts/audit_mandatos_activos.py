...
def run_audit_mandatos_activos():
    ...
    try:
        print("--- AUDITORÍA DE CONTRATOS DE MANDATO ACTIVOS ---")
        
        # Consulta para obtener los contratos de mandato activos y sus arriendos (si existen)
        query = """
            SELECT 
                cm.ID_CONTRATO_M,
                ca.ID_CONTRATO_A,
        ...
        print(f"\nTotal de contratos de mandato activos encontrados: {len(rows)}")

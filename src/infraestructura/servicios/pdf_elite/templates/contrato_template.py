...
class ContratoArrendamientoElite(BaseDocumentTemplate):
    ...
    def _add_resumen_partes(self, data: Dict[str, Any]):
        ...
        row_eco = [
            ...
            [p_kw("FECHA DE INICIO:"), p_val(data['fecha_inicio'])]
        ]
        ...
        row_fin = [
            [p_kw("FECHA DE TERMINACIÓN:"), p_val(data['fecha_fin'])]
        ]
        ...
        # 5. CANON
        data_table.append([p_kw("CANON:"), p_val(canon_fmt)])
        # 6. INICIO
        data_table.append([p_kw("INICIO:"), p_val(data['fecha_inicio'])])
        # 7. FIN
        data_table.append([p_kw("FIN:"), p_val(data['fecha_fin'])])

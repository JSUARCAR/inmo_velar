...
class RepositorioCodeudorSQLite:
    ...
    def _row_to_entity(self, row: sqlite3.Row) -> Codeudor:
        ...
        return Codeudor(
            ...
            fecha_ingreso_codeudor=(row_dict.get('fecha_ingreso_codeudor') or row_dict.get('FECHA_INGRESO_CODEUDOR')),
    ...
    def obtener_por_persona(self, id_persona: int) -> Optional[Codeudor]:
        ...
        cursor.execute(
            f"SELECT * FROM CODEUDORES WHERE ID_PERSONA = {placeholder}",
            (id_persona,)
        )
    ...
    def listar_activos(self) -> List[Codeudor]:
        ...
        cursor.execute(
            "SELECT * FROM CODEUDORES WHERE ESTADO_REGISTRO = TRUE"
        )
        ...
        with self.db.obtener_conexion() as conn:
            ...
            cursor.execute(
                ...
                (
                    ...
                    bool(codeudor.estado_registro) if codeudor.estado_registro is not None else True,

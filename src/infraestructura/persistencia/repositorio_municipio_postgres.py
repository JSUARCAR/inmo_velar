"""
Repositorio PostgreSQL para Municipio.
...
class RepositorioMunicipioPostgres:
    """Repositorio PostgreSQL para la entidad Municipio."""

    def __init__(self, db_manager: DatabaseManager):
        self.db = db_manager

    def _row_to_entity(self, row: dict) -> Municipio:

...
class RepositorioAsesorSQLite:
    ...
    def _row_to_entity(self, row) -> Asesor:
        ...
        return Asesor(
            ...
            comision_porcentaje_arriendo=(row_dict.get('comision_porcentaje_arriendo') or row_dict.get('COMISION_PORCENTAJE_ARRIENDO')),
            comision_porcentaje_venta=(row_dict.get('comision_porcentaje_venta') or row_dict.get('COMISION_PORCENTAJE_VENTA')),
    ...
    def obtener_por_id(self, id_asesor: int) -> Optional[Asesor]:
        ...
        cursor.execute(
            f"SELECT * FROM ASESORES WHERE ID_ASESOR = {placeholder}",
            (id_asesor,)
        )
    ...
    def obtener_por_persona(self, id_persona: int) -> Optional[Asesor]:
        ...
        cursor.execute(
            f"SELECT * FROM ASESORES WHERE ID_PERSONA = {placeholder}",
            (id_persona,)
        )
    ...
    def listar_activos(self) -> List[Asesor]:
        ...
        for row in cursor.fetchall():
            ...
            asesor.nombre_completo = (row_dict.get('nombre_completo') or row_dict.get('NOMBRE_COMPLETO'))

...
class RepositorioAlertaPostgres:
    ...
    def _row_to_entity(self, row) -> Alerta:
        ...
        return Alerta(
            ...
            fecha_generacion_alerta=_date_to_str(row_dict.get("FECHA_GENERACION_ALERTA")),
            fecha_vencimiento_alerta=_date_to_str(row_dict.get("FECHA_VENCIMIENTO_ALERTA")),
            ...
            resuelto_automaticamente=bool(row_dict.get("RESUELTO_AUTOMATICAMENTE", False)),

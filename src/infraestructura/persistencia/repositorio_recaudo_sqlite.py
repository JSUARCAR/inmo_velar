...
class RepositorioRecaudoSQLite:
    ...
    def _row_to_entity(self, row) -> Recaudo:
        ...
        return Recaudo(
            ...
            referencia_bancaria=(row_dict.get('referencia_bancaria') or row_dict.get('REFERENCIA_BANCARIA')),
    ...
    def _concepto_row_to_entity(self, row) -> RecaudoConcepto:
        ...
        return RecaudoConcepto(
            id_recaudo_concepto=(row_dict.get('id_recaudo_concepto') or row_dict.get('ID_RECAUDO_CONCEPTO')),
            id_recaudo=(row_dict.get('id_recaudo') or row_dict.get('ID_RECAUDO')),
    ...
    def listar_todos(self) -> List[Recaudo]:
        ...
        for row in rows:
            ...
            if recaudo:
                ...
                row_dict = self._get_row_dict(row)
                recaudo.direccion_propiedad = (row_dict.get('direccion_propiedad') or row_dict.get('direccion_propiedad'))

...
def migrar_postgresql():
    ...
    query = (
        "ALTER TABLE CONTRATOS_ARRENDAMIENTOS ADD COLUMN IF NOT EXISTS FECHA_PAGO TEXT;"
    )
    ...
    try:
        ...
        with db_manager.transaccion() as conn:
            ...
            print(
                "Columna FECHA_PAGO agregada exitosamente a CONTRATOS_ARRENDAMIENTOS (o ya existía)."
            )

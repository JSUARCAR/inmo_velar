...
def debug_prop_1():
    ...
    with db_manager.obtener_conexion() as conn:
        ...
        for m in mandatos:
            ...
            print(f"ID: {m_dict.get('ID_CONTRATO_M', m_dict.get('id_contrato_m'))} - Estado: {m_dict.get('ESTADO_CONTRATO_M', m_dict.get('estado_contrato_m'))}")
        ...
        for a in arriendos:
            ...
            print(f"ID: {a_dict.get('ID_CONTRATO_A', a_dict.get('id_contrato_a'))} - Estado: {a_dict.get('ESTADO_CONTRATO_A', a_dict.get('estado_contrato_a'))}")

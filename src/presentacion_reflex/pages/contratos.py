        ...
        rx.card(
            rx.hstack(
                ...
                rx.hstack(
                    rx.tooltip(
                        rx.icon_button(
                            rx.icon(rx.cond(ContratosState.is_grid_view, "table", "layout-grid"), size=18),
                            on_click=ContratosState.toggle_view,
                            variant="surface",
                            size="3",
                            color_scheme="gray",
                        ),
                        content=rx.cond(ContratosState.is_grid_view, "Ver como Tabla", "Ver como Tarjetas")
                    ),
                    rx.tooltip(
                        rx.button(
                        ...
                        rx.table.root(
                            rx.table.header(
                                rx.table.row(
                                    ...
                                    rx.table.column_header_cell("Tipo", style={"font-weight": "600"}),
                                    rx.table.column_header_cell("Propiedad", style={"font-weight": "600"}),
                                    rx.table.column_header_cell("Persona", style={"font-weight": "600"}),
                                    rx.table.column_header_cell("Fecha Inicio", style={"font-weight": "600"}),
                                    rx.table.column_header_cell("Fecha Fin", style={"font-weight": "600"}),
                                    rx.table.column_header_cell("Canon/Comisión", style={"font-weight": "600"}),
                                                        ...
                                                        rx.tooltip(
                                                            rx.icon_button(
                                                                ...
                                                                on_click=lambda: PDFState.generar_certificado_paz_y_salvo(
                                                                    contrato["id"],
                                                                    contrato.get("arrendatario", "Arrendatario")
                                                                ),
                                                                variant="ghost",
                                                                size="2",
                                                                color_scheme="green",
                                                    ...
                                                    rx.hstack(
                                                        ...
                                                        rx.tooltip(
                                                            rx.icon_button(
                                                                ...
                                                                on_click=lambda: PDFState.generar_certificado_paz_y_salvo(
                                                                    contrato["id"],
                                                                    contrato.get("propietario", "Propietario")
                                                                ),
                                                                variant="ghost",
                                                                size="2",
                                                                color_scheme="green",
                                                    ...
                                                    rx.hstack(
                                                        rx.tooltip(
                                                            rx.icon_button(
                                                                ...
                                                                on_click=rx.redirect("/propiedades"),
                                                                variant="ghost",
                                                                size="2",
                                                                color_scheme="orange",
                                                            ),
            ...
            rx.alert_dialog.content(
                ...
                rx.flex(
                    rx.alert_dialog.cancel(
                        rx.button("Cancelar", variant="soft", color_scheme="gray", on_click=ContratosState.cancel_renewal),
                    ),
                    rx.alert_dialog.action(
                        rx.button("Renovar", color_scheme="cyan", on_click=ContratosState.execute_renewal),
                    ),
                    spacing="3",
                    margin_top="16px",
                    justify="end",
...
def contratos() -> rx.Component:
    return rx.fragment(
        rx.toast.provider(),
        dashboard_layout(contratos_page())
    )

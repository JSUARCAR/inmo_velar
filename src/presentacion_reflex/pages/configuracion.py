...
def elite_input_field(
    label: str, placeholder: str, field_name: str, icon_tag: str, type_: str = "text"
) -> rx.Component:
...
@rx.page(
    route="/configuracion",
    title="Configuración | Inmobiliaria Velar",
    on_load=[AuthState.require_login, ConfiguracionState.on_load],
)

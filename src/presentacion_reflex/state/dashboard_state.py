...
class DashboardState(rx.State):
    ...
    # Datos de KPIs
    mora_data: Dict[str, Any] = {
        "monto_total": 0,
        "cantidad_contratos": 0
    }
    
    flujo_data: Dict[str, Any] = {
        "recaudado": 0,
        "esperado": 0,
        "porcentaje": 0
    }
    ...
    comisiones_data: Dict[str, Any] = {
        "monto_total": 0,
        "cantidad_liquidaciones": 0
    }
    ...
    evolucion_data: Dict[str, Any] = {
        "etiquetas": [],
        "valores": []
    }
    
    incidentes_data: Dict[str, Any] = {
        "por_estado": {}
    }
    ...
    async def load_dashboard_data(self):
        ...
        try:
            ...
            async with self:
                ...
                self.propiedades_tipo_data = servicio.obtener_propiedades_por_tipo(id_asesor=id_asesor)
    ...
    def vencimiento_chart_data(self) -> List[Dict[str, Any]]:
        ...
        return [
            {"name": "30 Días", "value": self.vencimiento_data.get("vence_30_dias", 0), "fill": "#8884d8"},
            {"name": "60 Días", "value": self.vencimiento_data.get("vence_60_dias", 0), "fill": "#82ca9d"},
            {"name": "90 Días", "value": self.vencimiento_data.get("vence_90_dias", 0), "fill": "#ffc658"},
        ]

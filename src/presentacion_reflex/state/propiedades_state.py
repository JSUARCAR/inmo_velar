        ...
        try:
            ...
            if propiedad:
                ...
                self.form_data = {
                    ...
                    "valor_canon": str(propiedad.canon_arrendamiento_estimado) if propiedad.canon_arrendamiento_estimado else "0",
                    "disponibilidad": str(propiedad.disponibilidad_propiedad) if propiedad.disponibilidad_propiedad is not None else "1",
                    "observaciones": propiedad.observaciones_propiedad or "",
                    
                    # Detalles Físicos
                    "habitaciones": str(propiedad.habitaciones) if propiedad.habitaciones is not None else "0",
                    "bano": str(propiedad.bano) if propiedad.bano is not None else "0",
                    "parqueadero": str(propiedad.parqueadero) if propiedad.parqueadero is not None else "0",
                    "estrato": str(propiedad.estrato) if propiedad.estrato is not None else "1",
                    
                    # Financiero / Venta
                    "valor_administracion": str(propiedad.valor_administracion) if propiedad.valor_administracion is not None else "0",
                    "valor_venta_propiedad": str(propiedad.valor_venta_propiedad) if propiedad.valor_venta_propiedad is not None else "0",
                    "comision_venta_propiedad": str(propiedad.comision_venta_propiedad) if propiedad.comision_venta_propiedad is not None else "0",
        ...
        try:
            ...
            def safe_int(key, default=0):
                ...
                if key == "disponibilidad":
                    if val == "Disponible": return 1
                    if val == "Ocupada": return 0
                    if str(val) == "1": return 1

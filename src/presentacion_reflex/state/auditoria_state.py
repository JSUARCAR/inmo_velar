        ...
        try:
            ...
            if self.search_query:
                ...
                entidades = [
                    ...
                    if (e.usuario and q in e.usuario.lower()) or 
                       (e.campo and q in e.campo.lower()) or
                       (e.motivo_cambio and q in e.motivo_cambio.lower())
                ]
            ...
            for ent in entidades:
                ...
                # Determinar color
                color = "blue"
                if ent.accion == 'INSERT': color = "green"
                elif ent.accion == 'UPDATE': color = "orange"
                elif ent.accion == 'DELETE': color = "red"

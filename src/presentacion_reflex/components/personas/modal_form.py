        ...
        rx.vstack(
            ...
            rx.grid(
                form_field(
                    ...
                    "Ej: 123456789",
                    value=PersonasState.form_data["numero_cuenta_propietario"],
                    on_change=lambda val: PersonasState.set_form_value("numero_cuenta_propietario", val),
                    icon="hash",
                ),
                rx.vstack(
        ...
        rx.vstack(
            ...
            rx.grid(
                form_field(
                    ...
                    "Ej: 10",
                    type="number",
                    value=PersonasState.form_data["comision_porcentaje_arriendo"],
                    on_change=lambda val: PersonasState.set_form_value("comision_porcentaje_arriendo", val),
                    icon="percent",
                ),
                form_field(
                    "Comisión % Venta",
                    ...
                    "Ej: 3",
                    type="number",
                    value=PersonasState.form_data["comision_porcentaje_venta"],
                    on_change=lambda val: PersonasState.set_form_value("comision_porcentaje_venta", val),
                    icon="percent",
                ),
                columns=rx.breakpoints(initial="1", sm="2"),
                spacing="4",
            ...
            form_field(
                ...
                "YYYY-MM-DD",
                type="date",
                value=PersonasState.form_data["fecha_vinculacion"],
                on_change=lambda val: PersonasState.set_form_value("fecha_vinculacion", val),
                icon="calendar",
            ),
            spacing="4",
            width="100%",
    ...
    return neuro_panel(
        rx.vstack(
            ...
            form_field(
                ...
                "Ej: 5",
                type="number",
                value=PersonasState.form_data["calificacion"],
                on_change=lambda val: PersonasState.set_form_value("calificacion", val),
                icon="star",
            ),
            form_textarea(
                "Observaciones",
    ...
    return rx.vstack(
        ...
        rx.grid(
            form_field(
                ...
                "Ej: 3001234567",
                required=True,
                value=PersonasState.form_data["telefono_principal"],
                on_change=lambda val: PersonasState.set_form_value("telefono_principal", val),
                icon="phone",
            ),
            form_field(
                "Correo Electrónico",

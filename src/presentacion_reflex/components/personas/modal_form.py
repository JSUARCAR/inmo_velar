    ...
    return rx.box(
        rx.vstack(
            rx.hstack(
                ...
                rx.text("Información Bancaria", size="3", weight="bold", color=styles.BRAND_PRIMARY),
                spacing="2",
            ),
            campo_formulario(
                "Banco",
                "banco_propietario",
                "Ej: Bancolombia",
                valor=PersonasState.form_data["banco_propietario"],
                al_cambiar=lambda val: PersonasState.set_upper("banco_propietario", val),
                icono="landmark",
            ),
            rx.grid(
                campo_formulario(
                    ...
                    "Ej: 123456789",
                    valor=PersonasState.form_data["numero_cuenta_propietario"],
                    al_cambiar=lambda val: PersonasState.set_form_value("numero_cuenta_propietario", val),
                    icono="hash",
                ),
                rx.vstack(
            ...
            campo_formulario(
                ...
                valor=PersonasState.form_data["documento_consignatario"],
                al_cambiar=lambda val: PersonasState.set_form_value("documento_consignatario", val),
                icono="credit_card",
            ),
            campo_formulario(
                ...
                valor=PersonasState.form_data["consignatario"],
                al_cambiar=lambda val: PersonasState.set_upper("consignatario", val),
                icono="user_check",
            ),
            area_texto_formulario(
                "Observaciones",

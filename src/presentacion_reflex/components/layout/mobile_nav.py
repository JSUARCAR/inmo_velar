import reflex as rx
from src.presentacion_reflex.components.layout.sidebar import sidebar_items, sidebar_footer
    ...
    return rx.box(
        rx.hstack(
            ...
            rx.drawer.root(
                ...
                rx.drawer.overlay(background_color="rgba(0, 0, 0, 0.7)", backdrop_filter="blur(2px)"),
                rx.drawer.portal(
                    rx.drawer.content(
                        rx.vstack(

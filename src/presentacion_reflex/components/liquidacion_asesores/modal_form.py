            ...
            rx.form.root(
                rx.flex(
                    ...
                    rx.grid(
                        ...
                        rx.flex(
                            ...
                            rx.box(
                                ...
                                rx.select.root(
                                    ...
                                    on_change=lambda val: LiquidacionAsesoresState.set_form_field("id_asesor", val),
                            ...
                            # Período
                            rx.box(
                                rx.text("Período (YYYY-MM)", size="2", weight="bold", margin_bottom="1"),
                                rx.input(
                                    name="periodo",
                                    type="month",
                                    placeholder="YYYY-MM",
                                    ...
                                    on_change=lambda val: LiquidacionAsesoresState.set_form_field("periodo", val),
                            ...
                            # Porcentaje
                            rx.box(
                                rx.text("Porcentaje Comisión (%)", size="2", weight="bold", margin_bottom="1"),
                                rx.input(
                                    ...
                                    on_change=lambda val: LiquidacionAsesoresState.set_form_field("porcentaje_comision", val)
                                ),
                                width="100%"
                            ),
                            direction="column",
                        ...
                        rx.box(
                            rx.text("Propiedades a Liquidar", size="2", weight="bold", margin_bottom="2"),
                            rx.scroll_area(
                                rx.flex(
                                    rx.cond(
                                        ...
                                        rx.foreach(
                                            ...
                                            lambda prop: rx.card(
                                                rx.flex(
                                                    rx.text(prop["DIRECCION_PROPIEDAD"], size="1", weight="bold"),
                                                    rx.text(f"Canon: ${prop['CANON_ARRENDAMIENTO']}", size="1", color="gray"),
                                                    direction="column",
                                                    spacing="1"
                                                ),
                                                padding="2",
                                        ...
                                        rx.text("No hay propiedades activas o no se ha seleccionado asesor.", size="1", color="gray", style={"fontStyle": "italic"})
                                    ),
                                    direction="column",
                                    spacing="2"
                                ),
                    ...
                    # Bonuses Section
                    rx.box(
                        rx.text("Otros Ingresos / Bonificaciones", size="2", weight="bold", margin_bottom="2"),
                        rx.grid(
                            rx.select.root(
                                ...
                                rx.select.content(
                                    rx.select.group(
                                        ...
                                        rx.select.item("Bono Cumplimiento", value="Bono Cumplimiento"),
                                        rx.select.item("Incentivo", value="Incentivo"),
                                        rx.select.item("Otros", value="Otros"),
                                    )
                                ),
                                value=LiquidacionAsesoresState.temp_bonus["tipo"],
                                on_change=lambda val: LiquidacionAsesoresState.set_temp_bonus_field("tipo", val),
                                width="100%"
                            ),
                            rx.input(
                                placeholder="Descripción",
                                value=LiquidacionAsesoresState.temp_bonus["descripcion"],
                                on_change=lambda val: LiquidacionAsesoresState.set_temp_bonus_field("descripcion", val),
                                width="100%"
                            ),
                            rx.input(
                                placeholder="Valor (+)",
                                ...
                                on_change=lambda val: LiquidacionAsesoresState.set_temp_bonus_field("valor", val),
                                width="100%"
                            ),
                            rx.button(
                                rx.icon("plus"),
                        ...
                        rx.cond(
                            (LiquidacionAsesoresState.selected_liquidacion_id > 0) & (LiquidacionAsesoresState.existing_bonuses.length() > 0),
                            rx.box(
                                rx.text("Bonificaciones Guardadas:", size="1", weight="bold", margin_bottom="1"),
                                rx.table.root(
                                    rx.table.header(
                                        rx.table.row(
                                    ...
                                    rx.table.body(
                                        rx.foreach(
                                            ...
                                            lambda b: rx.table.row(
                                                ...
                                                rx.table.cell(f"${b['valor']:,}", color="green", weight="bold"),
                                                rx.table.cell(
                                                    rx.button(
                                                        rx.icon("trash", size=16),
                                                        on_click=lambda _, id_b=b["id_bonificacion"]: LiquidacionAsesoresState.eliminar_bonificacion(id_b),
                                                        variant="ghost",
                                                        color_scheme="red",
                                                        size="1"
                                                    )
                                        ...
                                        rx.foreach(
                                            ...
                                            lambda b: rx.table.row(
                                                ...
                                                rx.table.cell(
                                                    rx.button(
                                                        rx.icon("trash", size=16),
                                                        on_click=lambda _, item=b: LiquidacionAsesoresState.remove_temp_bonus(item),
                                                        variant="ghost",
                                                        color_scheme="red",
                                                        size="1"
                                                    )
                    ...
                    # Discounts Section
                    rx.box(
                        rx.text("Descuentos Adicionales (Opcional)", size="2", weight="bold", margin_bottom="2"),
                        rx.grid(
                            rx.select.root(
                                ...
                                on_change=lambda val: LiquidacionAsesoresState.set_temp_discount_field("tipo", val),
                                width="100%"
                            ),
                            rx.input(
                                placeholder="Descripción",
                                value=LiquidacionAsesoresState.temp_discount["descripcion"],
                                on_change=lambda val: LiquidacionAsesoresState.set_temp_discount_field("descripcion", val),
                                width="100%"
                            ),
                            rx.input(
                                placeholder="Valor",
                                ...
                                on_change=lambda val: LiquidacionAsesoresState.set_temp_discount_field("valor", val),
                                width="100%"
                            ),
                            rx.button(
                                rx.icon("plus"),
                        ...
                        rx.cond(
                            (LiquidacionAsesoresState.selected_liquidacion_id > 0) & (LiquidacionAsesoresState.existing_discounts.length() > 0),
                            rx.box(
                                rx.text("Descuentos Guardados:", size="1", weight="bold", margin_bottom="1"),
                                rx.table.root(
                                    rx.table.header(
                                        rx.table.row(
                                            rx.table.column_header_cell("Tipo"),
                                        ...
                                        rx.foreach(
                                            ...
                                            lambda d: rx.table.row(
                                                ...
                                                rx.table.cell(
                                                    rx.button(
                                                        rx.icon("trash", size=16),
                                                        on_click=lambda _, id_d=d["id_descuento"]: LiquidacionAsesoresState.eliminar_descuento(id_d),
                                                        variant="ghost",
                                                        color_scheme="red",
                                                        size="1"
                                                    )
                        ...
                        rx.cond(
                            ...
                            rx.box(
                                rx.text("Descuentos Nuevos (Por Guardar):", size="1", weight="bold", margin_bottom="1"),
                                rx.table.root(
                                    rx.table.header(
                                        rx.table.row(
                                            rx.table.column_header_cell("Tipo"),
                                        ...
                                        rx.foreach(
                                            ...
                                            lambda d: rx.table.row(
                                                ...
                                                rx.table.cell(
                                                    rx.button(
                                                        rx.icon("trash", size=16),
                                                        on_click=lambda _, item=d: LiquidacionAsesoresState.remove_temp_discount(item),
                                                        variant="ghost",
                                                        color_scheme="red",
                                                        size="1"
                                                    )
                    ...
                    # Observaciones
                    rx.box(
                        rx.text("Observaciones Generales", size="2", weight="bold", margin_bottom="1"),
                        rx.text_area(
                            name="observaciones",
                            placeholder="Observaciones opcionales...",
                            width="100%",
                            value=LiquidacionAsesoresState.form_data["observaciones"],
                            on_change=lambda val: LiquidacionAsesoresState.set_form_field("observaciones", val)
                        ),
                        width="100%"
                    ),

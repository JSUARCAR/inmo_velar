        ...
        rx.alert_dialog.content(
            ...
            rx.alert_dialog.description(
                rx.vstack(
                    ...
                    rx.box(
                        rx.vstack(
                            rx.text("Propiedad:", font_weight="bold", color="var(--gray-11)", font_size="0.85em"),
                            rx.text(DesocupacionesState.finalize_info["direccion"], font_weight="medium"),
                            rx.text(DesocupacionesState.finalize_info["inquilino"], color="var(--gray-10)", font_size="0.9em"),
                            spacing="1",
                            align_items="start"
                        ),
                        padding="1em",
                    ...
                    rx.cond(
                        ...
                        rx.callout(
                           rx.vstack(
                                ...
                                rx.text(DesocupacionesState.finalize_info["mensaje_validacion"], font_weight="medium"),
                                spacing="2"
                           ),
                           icon="triangle_alert",
                           color_scheme="orange",

...
def form_field(label: str, name: str, value: str = "", type: str = "text", read_only: bool = False, required: bool = False) -> rx.Component:
        ...
        rx.dialog.content(
            ...
            rx.form.root(
                rx.vstack(
                    ...
                    rx.grid(
                        form_field("ID Contrato", "id_contrato_m", LiquidacionesState.form_data["id_contrato_m"].to(str), read_only=True),
                        form_field("Período", "periodo", LiquidacionesState.form_data["periodo"], read_only=True),
                        columns="2",
                        spacing="3",
                        width="100%",
                    ),
                    ...
                    rx.grid(
                        form_field("Otros Ingresos", "otros_ingresos", LiquidacionesState.form_data["otros_ingresos"].to(str), type="number"),
                        spacing="3",
                        width="100%",
                    ),
                    ...
                    rx.grid(
                        form_field("Gastos Administración", "gastos_administracion", LiquidacionesState.form_data["gastos_administracion"].to(str), type="number"),
                        form_field("Gastos Servicios", "gastos_servicios", LiquidacionesState.form_data["gastos_servicios"].to(str), type="number"),
                        form_field("Gastos Reparaciones", "gastos_reparaciones", LiquidacionesState.form_data["gastos_reparaciones"].to(str), type="number"),
                        form_field("Otros Egresos", "otros_egresos", LiquidacionesState.form_data["otros_egresos"].to(str), type="number"),
                        columns="2",
                        spacing="3",
                        width="100%",
                    ),

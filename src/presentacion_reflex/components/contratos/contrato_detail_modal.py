        ...
        rx.dialog.content(
            ...
            rx.vstack(
                ...
                rx.grid(
                    ...
                    detail_field("Fecha Inicio", ContratosState.contrato_detalle.get("fecha_inicio", "N/A")),
                    detail_field("Fecha Fin", ContratosState.contrato_detalle.get("fecha_fin", "N/A")),
                    detail_field("Duración (meses)", ContratosState.contrato_detalle.get("duracion", "N/A")),
                    columns="2",
                    spacing="4",
                    width="100%",
                ),
                ...
                rx.grid(
                    detail_field("Matrícula", ContratosState.contrato_detalle.get("matricula", "N/A")),
                    detail_field("Tipo", ContratosState.contrato_detalle.get("tipo_propiedad", "N/A")),
                    detail_field("Dirección", ContratosState.contrato_detalle.get("direccion", "N/A")),
                    detail_field("Área (m²)", ContratosState.contrato_detalle.get("area_m2", "N/A")),
                    columns="2",
                    spacing="4",
                    width="100%",
                ),
                ...
                rx.grid(
                    ...
                    detail_field("Documento", ContratosState.contrato_detalle.get("documento", "N/A")),
                    detail_field("Teléfono", ContratosState.contrato_detalle.get("telefono", "N/A")),
                ...
                rx.cond(
                    ...
                    rx.vstack(
                        ...
                        rx.grid(
                            detail_field("Nombre", ContratosState.contrato_detalle.get("codeudor", "N/A")),
                            detail_field("Documento", ContratosState.contrato_detalle.get("documento_codeudor", "N/A")),
                            columns="2",
                            spacing="4",
                            width="100%",
                        ),
                ...
                rx.grid(
                    ...
                    detail_field("Creado por", ContratosState.contrato_detalle.get("created_by", "N/A")),
                    detail_field("Fecha Creación", ContratosState.contrato_detalle.get("created_at", "N/A")),
                    rx.cond(
                        ContratosState.contrato_detalle.get("motivo_cancelacion"),
                        detail_field("Motivo Cancelación", ContratosState.contrato_detalle.get("motivo_cancelacion", "")),
                        rx.box(),
                    ),
                    columns="2",
                    spacing="4",

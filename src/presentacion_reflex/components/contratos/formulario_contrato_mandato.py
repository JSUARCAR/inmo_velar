                    ...
                    rx.form(
                        ...
                        rx.vstack(
                            ...
                            rx.grid(
                                ...
                                rx.vstack(
                                    rx.text("Número de Cuenta", size="2", weight="bold"),
                                    neuro_input(
                                ...
                                rx.vstack(
                                    rx.text("Tipo de Cuenta", size="2", weight="bold"),
                                    rx.select.root(
                                        rx.select.trigger(
                            ...
                            rx.grid(
                                rx.vstack(
                                    rx.text("Nombre Consignatario", size="2", weight="bold"),
                                    neuro_input(
                                        rx.input.slot(rx.icon("user-check", size=16)),
                                        type="text",
                                        name="consignatario",
                                ...
                                rx.vstack(
                                    rx.text("Documento Consignatario", size="2", weight="bold"),
                                    neuro_input(
                                        rx.input.slot(rx.icon("credit-card", size=16)),
                                        type="text",

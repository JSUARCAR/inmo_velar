...
from src.infraestructura.persistencia.repositorio_desocupacion_sqlite import RepositorioDesocupacionSQLite
    ...
    def iniciar_desocupacion(
        ...
        with self.db_manager.obtener_conexion() as conn:
            ...
            if row['ESTADO_CONTRATO_A'] != 'Activo':
                raise ValueError(f"El contrato debe estar Activo para iniciar desocupación")
    ...
    def finalizar_desocupacion(self, id_desocupacion: int, usuario: str):
        ...
        try:
            with self.db_manager.obtener_conexion() as conn:
                ...
                """
                cursor.execute(update_desoc_query, (fecha_real, timestamp, usuario, id_desocupacion))

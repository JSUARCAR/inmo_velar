...
class ServicioConfiguracion:
    ...
    def __init__(self, db_manager: DatabaseManager):
        ...
        from src.infraestructura.persistencia.repositorio_configuracion_empresa import (
            RepositorioConfiguracionEmpresa,
        )
    ...
    def crear_usuario(
        self, nombre_usuario: str, contrasena: str, rol: str, usuario_sistema: str
    ) -> Usuario:
        """
        ...
        if rol not in self.ROLES_DISPONIBLES:
            raise ValueError(
                f"Rol inválido. Valores permitidos: {', '.join(self.ROLES_DISPONIBLES)}"
            )
    ...
    def resetear_contrasena(
        self, id_usuario: int, nueva_contrasena: str, usuario_sistema: str
    ) -> bool:
        """
    ...
    def actualizar_parametro(
        self, id_parametro: int, nuevo_valor: str, usuario_sistema: str
    ) -> bool:
        """
    ...
    def actualizar_parametros_por_categoria(
        self, categoria: str, valores: Dict[int, str], usuario_sistema: str
    ) -> int:
        """

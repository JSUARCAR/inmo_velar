...
class ServicioSeguros:
    ...
    def actualizar_seguro(self, id_seguro: int, datos: Dict[str, Any], usuario_sistema: str) -> Seguro:
        """
    ...
    def crear_poliza(self, id_contrato: int, id_seguro: int, fecha_inicio: str, fecha_fin: str, numero_poliza: str, usuario: str):

...
class ServicioTerceros:
    ...
    def crear_persona_con_roles(
        ...
        resultado = {"persona": persona_creada, "roles": {}}
        ...
        if "ARRENDATARIO" in roles:
            ...
            resultado["roles"]["arrendatario"] = self.repo_arrendatario.crear(
                arrendatario, usuario_sistema
            )
    ...
    def obtener_persona_con_roles(self, id_persona: int) -> Optional[dict]:
        ...
        resultado = {"persona": persona, "roles": {}}

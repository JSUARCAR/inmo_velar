...
class ServicioNotificaciones:
    ...
    def _cargar_template(
        self, nombre_destinatario: str, mensaje_cuerpo: str, contenido_extra: str = ""
    ) -> str:
    ...
    def notificar_recibo_vencido_whatsapp(
        self, recibo, telefono_inquilino: str, nombre_inquilino: str
    ) -> bool:
        """
    ...
    def notificar_liquidacion_asesor_whatsapp(
        self, liquidacion, telefono_asesor: str, nombre_asesor: str
    ) -> bool:
        """

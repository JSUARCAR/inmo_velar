    ...
    def remover_rol(self, id_persona: int, nombre_rol: str) -> None:
        ...
        with self.db.obtener_conexion() as conn:
            ...
            if nombre_rol == "Propietario":
                cursor.execute(
                    f"DELETE FROM PROPIETARIOS WHERE ID_PERSONA = {placeholder}", (id_persona,)
                )
            elif nombre_rol == "Arrendatario":
                cursor.execute(
                    f"DELETE FROM ARRENDATARIOS WHERE ID_PERSONA = {placeholder}", (id_persona,)
                )
            elif nombre_rol == "Codeudor":
                cursor.execute(
                    f"DELETE FROM CODEUDORES WHERE ID_PERSONA = {placeholder}", (id_persona,)
                )
                ...
                cursor.execute(
                    f"DELETE FROM PROVEEDORES WHERE ID_PERSONA = {placeholder}", (id_persona,)
                )

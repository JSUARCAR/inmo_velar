...
TIPOS_DOCUMENTO_MODULO: Dict[str, Dict[str, Any]] = {
    ...
    "CONTRATO_ARRENDAMIENTO": {
        ...
        "cedula_arrendatario": {
            "label": "Cédula Arrendatario",
            "tipos": [".jpg", ".png", ".pdf"],
            "max_size": 2 * 1024 * 1024,
        },
        "cedula_codeudor": {
            "label": "Cédula Codeudor",
            "tipos": [".jpg", ".png", ".pdf"],
            "max_size": 2 * 1024 * 1024,
        },
        "acta_entrega": {
    ...
    "INCIDENTE": {
        ...
        "comprobante_reparacion": {
            "label": "Comprobante Reparación",
            "tipos": [".pdf"],
            "max_size": 5 * 1024 * 1024,
        },
    },
    "DESOCUPACION": {
        ...
        "foto_estado_final": {
            "label": "Foto Estado Final",
            "tipos": [".jpg", ".png"],
            "max_size": 3 * 1024 * 1024,
            "multiple": True,
        },
        "paz_y_salvo_servicios": {
            "label": "Paz y Salvo Servicios",
            "tipos": [".pdf"],
            "max_size": 2 * 1024 * 1024,
        },
    },

...
class IRepositorioLiquidacion(Protocol):
    ...
    def cancelar_masivamente(
        self, ids: List[int], motivo: str, usuario_sistema: str
    ) -> Dict[str, List[int]]: ...
    def reversar_masivamente(
        self, ids: List[int], usuario_sistema: str
    ) -> Dict[str, List[int]]: ...
    def cancelar_por_propietario_y_periodo(
        self, id_prop: int, periodo: str, motivo: str, usr: str
    ) -> int: ...
    def reversar_por_propietario_y_periodo(
        self, id_prop: int, periodo: str, usr: str
    ) -> int: ...

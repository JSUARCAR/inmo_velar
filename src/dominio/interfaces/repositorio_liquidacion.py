...
class IRepositorioLiquidacion(Protocol):
    ...
    def reversar_pago(self, id_liquidacion: int, usuario_sistema: str, motivo: str) -> Dict[str, Any]: ...
    ...
    def reversar_pago_por_propietario_y_periodo(self, id_propietario: int, periodo: str, usuario_sistema: str, motivo: str) -> Dict[str, Any]: ...

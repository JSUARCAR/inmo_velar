...
def heading_1():
    """Titulo principal (H1)."""
    return ft.TextStyle(
        size=32, weight=ft.FontWeight.BOLD, color=colors.TEXT_PRIMARY, font_family="Outfit"
    )
...
def heading_2():
    ...
    return ft.TextStyle(
        size=24, weight=ft.FontWeight.W_600, color=colors.TEXT_PRIMARY, font_family="Outfit"
    )
...
def heading_3():
    """Titulo terciario (H3)."""
    return ft.TextStyle(
        size=18, weight=ft.FontWeight.W_600, color=colors.TEXT_PRIMARY, font_family="Inter"
    )


def body_text():
    """Texto de cuerpo normal."""
    return ft.TextStyle(size=14, color=colors.TEXT_PRIMARY, font_family="Inter")


def caption_text():
    """Texto pequeño (captions, timestamps)."""
    return ft.TextStyle(size=12, color=colors.TEXT_SECONDARY, font_family="Inter")


def breadcrumb_text():
    """Texto para breadcrumbs (navegación)."""
    return ft.TextStyle(
        size=14, color=colors.TEXT_SECONDARY, weight=ft.FontWeight.W_500, font_family="Inter"
    )
...
def badge_alert_count(count: int):
    ...
    return ft.Container(
        content=ft.Text(
            str(count), size=10, weight=ft.FontWeight.BOLD, color=colors.TEXT_ON_PRIMARY
        ),
        bgcolor=colors.ERROR,
        border_radius=10,
        width=20,

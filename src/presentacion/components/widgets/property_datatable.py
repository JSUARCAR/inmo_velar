...
class PropertyDataTable(ft.Column):
    ...
    def _construir_tabla(self) -> ft.DataTable:
        ...
        for prop in self.propiedades:
            ...
            row = ft.DataRow(
                cells=[
                    ...
                    ft.DataCell(
                        ft.Text(
                            prop.direccion_propiedad[:40] + "..." if len(prop.direccion_propiedad) > 40 else prop.direccion_propiedad,
                            size=12,
                            color=colors.TEXT_SECONDARY,
                    ...
                    # Disponibilidad
                    ft.DataCell(
                        self.crear_badge_disponibilidad(disponible)
                    ),
                    # Área
                    ft.DataCell(
                        ft.Text(
                    ...
                    ft.DataCell(
                        ft.Row(
                            [
                                ...
                                ft.Text(str(prop.habitaciones or 0), size=11, color=colors.TEXT_SECONDARY),
                                ...
                                ft.Icon(ft.Icons.DIRECTIONS_CAR, size=12, color=colors.TEXT_DISABLED),
                                ft.Text(str(prop.parqueadero or 0), size=11, color=colors.TEXT_SECONDARY),
                            ],
                            spacing=4,
                            tight=True
                        )
                    ...
                    ft.DataCell(
                        ft.Text(
                            ...
                            size=12,
                            color=colors.TEXT_PRIMARY,
                            weight=ft.FontWeight.BOLD if prop.valor_venta_propiedad else ft.FontWeight.NORMAL
                        )
                    ),
                    # Acciones
                    ft.DataCell(
                        ft.Row(
                            [
                                ...
                                ft.IconButton(
                                    ...
                                    on_click=make_toggle_handler(prop.id_propiedad, prop.disponibilidad_propiedad)
                                ),
                            ],
                            spacing=0,
                            tight=True
        ...
        return ft.DataTable(
            columns=[
                ft.DataColumn(
                    ft.Text("Matrícula", weight=ft.FontWeight.BOLD, size=13, color=colors.TEXT_PRIMARY)
                ),
                ft.DataColumn(
                    ft.Text("Tipo", weight=ft.FontWeight.BOLD, size=13, color=colors.TEXT_PRIMARY)
                ),
                ft.DataColumn(
                    ft.Text("Dirección", weight=ft.FontWeight.BOLD, size=13, color=colors.TEXT_PRIMARY)
                ),
                ft.DataColumn(
                    ft.Text("Disponibilidad", weight=ft.FontWeight.BOLD, size=13, color=colors.TEXT_PRIMARY)
                ),
                ft.DataColumn(
                    ft.Text("Área", weight=ft.FontWeight.BOLD, size=13, color=colors.TEXT_PRIMARY)
                ),
                ft.DataColumn(
                    ft.Text("Caract.", weight=ft.FontWeight.BOLD, size=13, color=colors.TEXT_PRIMARY)
                ),
                ft.DataColumn(
                    ft.Text("Precio Venta", weight=ft.FontWeight.BOLD, size=13, color=colors.TEXT_PRIMARY)
                ),
                ft.DataColumn(
                    ft.Text("Acciones", weight=ft.FontWeight.BOLD, size=13, color=colors.TEXT_PRIMARY)
                ),
            ],
            rows=rows,
            border=ft.border.all(1, colors.BORDER_DEFAULT),

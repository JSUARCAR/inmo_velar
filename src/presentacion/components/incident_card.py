            ...
            content=ft.Column(
                controls=[
                    ft.ListTile(
                        ...
                        title=ft.Text(
                            f"Incidente #{self.incidente.id_incidente}", weight=ft.FontWeight.BOLD
                        ),
                        subtitle=ft.Text(
                    ...
                    ft.Container(
                        content=ft.Row(
                            controls=[
                                ft.Container(
                                    content=ft.Text(
                                        self.incidente.estado, size=12, color=ft.Colors.WHITE
                                    ),
                                ...
                                ft.Text(
                                    (
                                        self.incidente.fecha_incidente[:10]
                                        if isinstance(self.incidente.fecha_incidente, str)
                                        else self.incidente.fecha_incidente.strftime("%Y-%m-%d")
                                    ),
                                    size=12,

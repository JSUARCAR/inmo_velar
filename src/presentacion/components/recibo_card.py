            ...
            content=ft.Column(
                [
                    ...
                    ft.Row(
                        [
                            ft.Container(
                                content=ft.Icon(self._get_service_icon(), color=colors.PRIMARY, size=24),
                            ...
                            ft.Column(
                                [
                                    ft.Text(self.recibo.tipo_servicio, weight=ft.FontWeight.BOLD, size=16),
                                    ft.Text(self.recibo.periodo_recibo, color=colors.TEXT_SECONDARY, size=12),
                                ],
                                spacing=0,
                                expand=True
                            ),
                        ...
                        [
                            ft.Column(
                                [
                                    ...
                                    ft.Text(self.recibo.fecha_vencimiento, size=12, weight=ft.FontWeight.W_500),
                                ]
                            ),
                            ft.Column(
                                [
                                    ft.Text("Valor", size=10, color=colors.TEXT_SECONDARY),
                                    ft.Text(f"${self.recibo.valor_recibo:,.0f}", size=14, weight=ft.FontWeight.BOLD, color=colors.PRIMARY),
                                ],

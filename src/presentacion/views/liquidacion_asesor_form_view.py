...
def crear_liquidacion_asesor_form_view(
    ...
    def renderizar_descuentos():
        ...
        if not descuentos_lista:
            descuentos_container.current.controls = [
                ft.Container(
                    content=ft.Text("No hay descuentos agregados", size=13, color="#999", italic=True),
                    padding=15,
    ...
    if es_edicion:
        try:
            ...
            liquidacion_actual = detalle['liquidacion']
    ...
    seccion_comision = ft.Container(
        content=ft.Column([
            ft.Text("2. CÁLCULO DE COMISIÓN", size=16, weight=ft.FontWeight.BOLD, color="#1976d2"),
            ft.Divider(height=1, color="#e0e0e0"),
            ft.ResponsiveRow([
                ft.TextField(
                    ref=txt_canon,
    ...
    seccion_descuentos = ft.Container(
        content=ft.Column([
            ft.Row([
                ft.Text("3. DESCUENTOS", size=16, weight=ft.FontWeight.BOLD, color="#1976d2"),
        ...
        content=ft.Column([
            ...
            ft.Container(
                content=ft.Column([
                    ...
                    ft.Text("(Comisión Bruta - Descuentos)", size=12, color="#999", italic=True)

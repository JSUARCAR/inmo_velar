...
class ProveedorFormView(ft.Column):
    def __init__(self, page: ft.Page, servicio_proveedores: ServicioProveedores, servicio_personas: ServicioPersonas, on_navigate, id_proveedor=None):
        ...
        self.btn_cancelar = ft.TextButton("Cancelar", on_click=lambda _: self.on_navigate("proveedores"))
        ...
        self.controls = [
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ft.Row([self.tf_buscar_persona, ft.IconButton(ft.Icons.SEARCH, on_click=self.buscar_persona)]),
                    self.lv_personas,
                    self.card_persona
                ])
            ),
            ...
            ft.Container(
                content=ft.Column([
                    ...
                    ft.Row([self.btn_guardar, self.btn_cancelar], alignment=ft.MainAxisAlignment.END)
                ]),
                padding=20,
    ...
    def seleccionar_persona(self, persona):
        ...
        contenido = ft.Container(
            padding=10,
            content=ft.Column([
                ft.Text(f"Persona Seleccionada: {persona.nombre_completo}", weight=ft.FontWeight.BOLD),
    ...
    def guardar_proveedor(self, e):
        ...
        try:
            datos = {
                "id_persona": self.persona_seleccionada.persona.id_persona if self.persona_seleccionada else None,

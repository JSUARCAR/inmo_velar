...
class IncidenteDetailView(ft.Column):
    def __init__(
        ...
        on_refrescar_incidentes: Callable = None,
    ):
    ...
    def _crear_info_panel(self, inc, propiedad):
        ...
        direccion_display = (
            propiedad.direccion_propiedad if propiedad else f"Propiedad ID: {inc.id_propiedad}"
        )
                        ...
                        [
                            ...
                            ft.Column(
                                [
                                    ...
                                    ft.Text(
                                        str(inc.dias_sin_resolver),
                                        weight=ft.FontWeight.BOLD,
                                        color=(
                                            ft.Colors.RED_600
                                            if inc.dias_sin_resolver > 7
                            ...
                            (
                                ft.Column(
                                    [
                                        ft.Text(
                                            "Responsable Pago", size=12, color=ft.Colors.GREY_600
                                        ),
                                        ft.Text(
                                            inc.responsable_pago or "Sin asignar",
                                            weight=ft.FontWeight.BOLD,
                                        ),
                                    ],
                                    spacing=2,
                                )
                                if inc.responsable_pago
                                else ft.Container()
                            ),
                        ],
                        spacing=30,
    ...
    def _crear_cotizaciones_panel(self, inc):
        ...
        cotizaciones_pendientes = [
            c for c in self.detalle["cotizaciones"] if c.estado_cotizacion == "Pendiente"
        ]
        cotizaciones_rechazadas = [
            c for c in self.detalle["cotizaciones"] if c.estado_cotizacion == "Rechazada"
        ]
        cotizacion_aprobada = next(
            (c for c in self.detalle["cotizaciones"] if c.estado_cotizacion == "Aprobada"), None
        )
                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ...
                            ft.Divider(height=10),
                            ft.Text(
                                f"Proveedor ID: {cotizacion_aprobada.id_proveedor}",
                                weight=ft.FontWeight.BOLD,
                                size=16,
                            ),
                            ft.Row(
                                [
                                    ft.Column(
                                        [
                                            ft.Text(
                                                "💵 Materiales", size=12, color=ft.Colors.GREY_700
                                            ),
                                            ft.Text(
                                                f"${cotizacion_aprobada.valor_materiales:,.0f}",
                                                size=14,
                                                weight=ft.FontWeight.BOLD,
                                            ),
                                        ],
                                    ...
                                    ft.Column(
                                        [
                                            ft.Text(
                                                "👷 Mano de Obra", size=12, color=ft.Colors.GREY_700
                                            ),
                                            ft.Text(
                                                f"${cotizacion_aprobada.valor_mano_obra:,.0f}",
                                                size=14,
                                                weight=ft.FontWeight.BOLD,
                                            ),
                                        ],
                                    ...
                                    ft.Column(
                                        [
                                            ...
                                            ft.Text(
                                                f"{cotizacion_aprobada.dias_estimados}",
                                                size=14,
                                                weight=ft.FontWeight.BOLD,
                                            ),
                                        ],
                            ...
                            ft.Row(
                                [
                                    ...
                                    ft.Text(
                                        f"${cotizacion_aprobada.valor_total:,.0f}",
                                        size=20,
                                        weight=ft.FontWeight.BOLD,
                            ...
                            ft.Text(
                                cotizacion_aprobada.descripcion_trabajo or "Sin descripción",
                                size=12,
                                italic=True,
                            ),
                        ],
                        ...
                        content=ft.Row(
                            [
                                ...
                                ft.Column(
                                    [
                                        ft.Text(
                                            f"Proveedor ID: {cot.id_proveedor}",
                                            weight=ft.FontWeight.BOLD,
                                        ),
                                        ft.Text(
                                            f"Total: ${cot.valor_total:,.0f} | {cot.dias_estimados} días",
                                            size=12,
                                        ),
                                        ft.Text(
                                            cot.descripcion_trabajo or "Sin descripción",
                                            size=11,
                                ...
                                ft.Row(
                                    [
                                        ft.ElevatedButton(
                                            ...
                                            bgcolor=ft.Colors.GREEN_600,
                                            color=ft.Colors.WHITE,
                                            on_click=lambda _, id_c=cot.id_cotizacion: self.aprobar_cot(
                                                id_c
                                            ),
                                        ),
                                        ft.ElevatedButton(
                                            ...
                                            color=ft.Colors.WHITE,
                                            on_click=lambda _, id_c=cot.id_cotizacion: self.abrir_modal_rechazo(
                                                id_c
                                            ),
                                        ),
                                    ],
        ...
        if cotizaciones_rechazadas:
            ...
            cotizaciones_controls.append(
                ft.ExpansionTile(
                    title=ft.Text(
                        f"Cotizaciones Rechazadas ({len(cotizaciones_rechazadas)})",
                        size=13,
                        color=ft.Colors.GREY_600,
                    ),
        ...
        if not self.detalle["cotizaciones"]:
            cotizaciones_controls.append(
                ft.Container(
                    content=ft.Text(
                        "No hay cotizaciones registradas.", italic=True, color=ft.Colors.GREY_600
                    ),
                    padding=20,
            ...
            content=ft.Column(
                [
                    ...
                    ft.Column(
                        ...
                        height=300 if len(self.detalle["cotizaciones"]) > 2 else None,
                    ),
                ],
                spacing=10,
            ),
    ...
    def _crear_historial_panel(self):
            ...
            return ft.Container(
                content=ft.Column(
                    [
                        ...
                        ft.Text(
                            "No hay historial registrado.", italic=True, color=ft.Colors.GREY_600
                        ),
                    ]
                ),
                padding=10,
                        ...
                        [
                            ...
                            ft.Column(
                                [
                                    ...
                                    ft.Text(
                                        (
                                            f"{h.estado_anterior or 'N/A'} → {h.estado_nuevo}"
                                            if h.estado_nuevo
                                            else (h.comentario or "Sin comentario")
                                        ),
                                        size=11,
                                        color=ft.Colors.GREY_700,
                                    ),
                                    ft.Text(
                                        str(h.fecha_cambio)[:19], size=10, color=ft.Colors.GREY_500
                                    ),
                                ],
                                spacing=2,
                                expand=True,
        ...
        return ft.ExpansionTile(
            title=ft.Text(
                f"Historial de Cambios ({len(historial)})", size=16, weight=ft.FontWeight.BOLD
            ),
            ...
            controls=[
                ft.Container(
                    content=DocumentManager(
                        entidad_tipo="INCIDENTE", entidad_id=str(inc.id_incidente), page=self.page
                    ),
                    padding=10,
                )
            ],
    ...
    def aprobar_cot(self, id_cotizacion):
        try:
            self.servicio.aprobar_cotizacion(
                self.id_incidente, id_cotizacion, "Sistema", "Inquilino"
            )
            self.page.snack_bar = ft.SnackBar(
                ft.Text("✅ Cotización aprobada exitosamente."), bgcolor=ft.Colors.GREEN_600
            )
            ...
            self.page.snack_bar = ft.SnackBar(
                ft.Text(f"Error: {str(ex)}"), bgcolor=ft.Colors.RED_600
            )
            self.page.snack_bar.open = True
            self.page.update()
        ...
        def confirmar_rechazo(e):
            ...
            try:
                ...
                self.servicio.rechazar_cotizacion(
                    self.id_incidente, id_cotizacion, "Sistema", txt_motivo.value
                )
                ...
                self.page.snack_bar = ft.SnackBar(
                    ft.Text("❌ Cotización rechazada."), bgcolor=ft.Colors.ORANGE_600
                )
                self.page.snack_bar.open = True
                # Invalidar caché del tablero kanban
                if self.on_refrescar_incidentes:
    ...
    def iniciar_reparacion(self, e):
        ...
        try:
            ...
            self.page.snack_bar = ft.SnackBar(
                ft.Text("🔧 Reparación iniciada."), bgcolor=ft.Colors.BLUE_600
            )
            self.page.snack_bar.open = True
            # Invalidar caché del tablero kanban
            if self.on_refrescar_incidentes:
    ...
    def abrir_modal_finalizacion(self, e):
        ...
        def confirmar_finalizacion(e):
            try:
                ...
                if modal_container[0]:
                    self.page.close(modal_container[0])
                self.page.snack_bar = ft.SnackBar(
                    ft.Text("✅ Incidente finalizado exitosamente."), bgcolor=ft.Colors.GREEN_600
                )
                self.page.snack_bar.open = True
                # Invalidar caché del tablero kanban
                if self.on_refrescar_incidentes:
        ...
        modal = ft.AlertDialog(
            ...
            actions=[
                ...
                ft.ElevatedButton(
                    "Finalizar",
                    on_click=confirmar_finalizacion,
                    bgcolor=ft.Colors.GREEN_600,
                    color=ft.Colors.WHITE,
                ),
            ],
    ...
    def abrir_modal_cancelacion(self, e):
        ...
        def confirmar_cancelacion(e):
            if not txt_motivo.value or not txt_motivo.value.strip():
                self.page.snack_bar = ft.SnackBar(
                    ft.Text("El motivo es obligatorio"), bgcolor=ft.Colors.ORANGE_600
                )
                self.page.snack_bar.open = True
                self.page.update()
                return
            ...
            try:
                ...
                if modal_container[0]:
                    self.page.close(modal_container[0])
                self.page.snack_bar = ft.SnackBar(
                    ft.Text("❌ Incidente cancelado."), bgcolor=ft.Colors.RED_600
                )
                self.page.snack_bar.open = True
                # Invalidar caché del tablero kanban
                if self.on_refrescar_incidentes:
        ...
        try:
            ...
            if not proveedores:
                ...
                dlg = ft.AlertDialog(
                    ...
                    content=ft.Text(
                        "No hay proveedores registrados en el sistema. Debe registrar al menos un proveedor antes de crear una cotización."
                    ),
            ...
            dd_proveedor = ft.Dropdown(
                ...
                options=[
                    ft.dropdown.Option(
                        key=str(p.id_proveedor), text=f"{p.especialidad} - {p.nombre_completo}"
                    )
                    for p in proveedores
                ],
                width=350,
            )
            txt_materiales = ft.TextField(
                label="Costo Materiales", value="0", keyboard_type=ft.KeyboardType.NUMBER
            )
            txt_mano_obra = ft.TextField(
                label="Costo Mano de Obra", value="0", keyboard_type=ft.KeyboardType.NUMBER
            )
            txt_dias = ft.TextField(
                label="Días Estimados", value="1", keyboard_type=ft.KeyboardType.NUMBER
            )
            ...
            def guardar_cotizacion(e):
                ...
                try:
                    ...
                    self.page.close(modal)
                    self.page.snack_bar = ft.SnackBar(
                        ft.Text("✅ Cotización agregada exitosamente"), bgcolor=ft.Colors.GREEN_600
                    )
                    self.page.snack_bar.open = True
                    # Invalidar caché del tablero kanban
                    if self.on_refrescar_incidentes:
            ...
            modal = ft.AlertDialog(
                ...
                content=ft.Column(
                    [dd_proveedor, txt_materiales, txt_mano_obra, txt_dias, txt_descripcion],
                    tight=True,
                    width=400,
                    spacing=10,
                ),
            ...
            self.page.snack_bar = ft.SnackBar(
                ft.Text(f"Error interno: {str(ex)}"), bgcolor=ft.Colors.RED_600
            )
            self.page.snack_bar.open = True
            self.page.update()

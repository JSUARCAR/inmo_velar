            ...
            filas.append(
                ft.DataRow(
                    cells=[
                        ...
                        ft.DataCell(
                            ft.Container(
                                content=ft.Text(rec['estado'], color="white", size=12, weight=ft.FontWeight.BOLD),
                                bgcolor={'Aplicado':'#4caf50', 'Pendiente':'#ff9800', 'Reversado':'#f44336'}.get(rec['estado'], "grey"),
...
def crear_recaudos_list_view(page, servicio_financiero, on_nuevo_recaudo, on_ver_detalle, on_aprobar=None, on_reversar=None):
    return RecaudosListView(page, servicio_financiero, on_nuevo_recaudo, on_ver_detalle, on_aprobar, on_reversar)

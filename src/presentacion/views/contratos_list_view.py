...
class ContratosListView(ft.Container):
    def __init__(
                ...
                ft.Tab(
                    ...
                    content=ft.Container(
                        content=ft.Column(
                            [
                                ft.Text(
                                    "Listado de contratos de mandato activos e históricos.",
                ...
                ft.Tab(
                    ...
                    content=ft.Container(
                        content=ft.Column(
                            [
                                ft.Text(
                                    "Listado de contratos de arrendamiento activos e históricos.",
                                    color=colors.TEXT_SECONDARY,
                                ),
                                ft.Column(
                                    [self.tabla_arriendos],
                                    scroll=ft.ScrollMode.AUTO,
                                    height=500,
                                    expand=True,
                                ),
        ...
        self.content = ft.Column(
            [
                ...
                ft.Container(ref=self.main_content_ref, expand=True),
    ...
    def actualizar_tablas(self):
        ...
        if self.active_tab == "MANDATOS":
            self.tabla_mandatos.rows = [
                self.construir_fila_mandato(m) for m in self.contratos_actuales
            ]
        else:
            self.tabla_arriendos.rows = [
                self.construir_fila_arriendo(a) for a in self.contratos_actuales
            ]

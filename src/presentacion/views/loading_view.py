...
class LoadingView(ft.Container):
    ...
    def _crear_componentes(self):
        ...
        self.icono = ft.Icon(ft.Icons.APARTMENT, size=80, color=colors.PRIMARY)
        ...
        # Spinner animado
        self.spinner = ft.ProgressRing(width=20, height=20, stroke_width=2, color=colors.PRIMARY)
        ...
        contenedor_progreso = ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Row(
                        [self.spinner, ft.Container(width=8), self.texto_estado],

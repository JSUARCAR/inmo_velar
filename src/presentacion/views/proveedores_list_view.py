...
class ProveedoresListView(ft.Column):
    ...
    def _update_table(self):
        ...
        for p in self.proveedores:
            ...
            nombre = (
                p.nombre_completo
                if hasattr(p, "nombre_completo") and p.nombre_completo
                else "Desconocido"
            )
                            ...
                            ft.Row(
                                [
                                    ft.IconButton(
                                        icon=ft.Icons.EDIT,
                                        tooltip="Editar",
                                        on_click=lambda e, id=p.id_proveedor: self.on_navigate(
                                            "proveedor_form", id_proveedor=id
                                        ),
                                    ),
                                    ft.IconButton(
                                        ...
                                        on_click=lambda e, id=p.id_proveedor: self.confirmar_eliminacion(
                                            id
                                        ),
                                    ),
                                ]
    ...
    def confirmar_eliminacion(self, id_proveedor):
        ...
        dlg = ft.AlertDialog(
            ...
            actions=[
                ...
                ft.TextButton(
                    "Eliminar", on_click=eliminar, style=ft.ButtonStyle(color=ft.Colors.ERROR)
                ),
            ],
        )

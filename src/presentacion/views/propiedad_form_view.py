...
def crear_propiedad_form_view(
    ...
    if es_edicion:
        ...
        if not propiedad_actual:
            page.snack_bar = ft.SnackBar(
                ft.Text("Propiedad no encontrada"),
    ...
    txt_fecha_ingreso = ft.TextField(
        ...
        value=propiedad_actual.fecha_ingreso_propiedad if propiedad_actual else datetime.datetime.now().date().isoformat(),
        width=200,
    ...
    txt_habitaciones = ft.TextField(
        label="Habitaciones",
        hint_text="0",
        value=str(propiedad_actual.habitaciones) if propiedad_actual and propiedad_actual.habitaciones else "",
        width=120,
        keyboard_type=ft.KeyboardType.NUMBER,
    ...
    txt_parqueaderos = ft.TextField(
        label="Parqueaderos",
        hint_text="0",
        value=str(propiedad_actual.parqueadero) if propiedad_actual and propiedad_actual.parqueadero else "",
        width=140,
        keyboard_type=ft.KeyboardType.NUMBER,
    ...
    dropdown_estrato = ft.Dropdown(
        ...
        value=str(propiedad_actual.estrato) if propiedad_actual and propiedad_actual.estrato else None,
        width=120
    )
    ...
    txt_admin = ft.TextField(
        ...
        hint_text="0",
        value=str(propiedad_actual.valor_administracion) if propiedad_actual and propiedad_actual.valor_administracion else "",
        width=200,
        keyboard_type=ft.KeyboardType.NUMBER,
    ...
    txt_canon = ft.TextField(
        ...
        hint_text="0",
        value=str(propiedad_actual.canon_arrendamiento_estimado) if propiedad_actual and propiedad_actual.canon_arrendamiento_estimado else "",
        width=250,
        keyboard_type=ft.KeyboardType.NUMBER,
    ...
    txt_valor_venta = ft.TextField(
        ...
        hint_text="0",
        value=str(propiedad_actual.valor_venta_propiedad) if propiedad_actual and propiedad_actual.valor_venta_propiedad else "",
        width=200,
        keyboard_type=ft.KeyboardType.NUMBER,
    ...
    txt_comision_venta = ft.TextField(
        ...
        hint_text="0",
        value=str(propiedad_actual.comision_venta_propiedad) if propiedad_actual and propiedad_actual.comision_venta_propiedad else "",
        width=180,
        keyboard_type=ft.KeyboardType.NUMBER,
    ...
    txt_telefono_admin = ft.TextField(
        ...
        value=propiedad_actual.telefono_administracion if propiedad_actual and propiedad_actual.telefono_administracion else "",
        width=200,
    ...
    dropdown_tipo_cuenta = ft.Dropdown(
        ...
        value=propiedad_actual.tipo_cuenta_administracion if propiedad_actual and propiedad_actual.tipo_cuenta_administracion else None,
        width=200,
    )
    ...
    txt_numero_cuenta = ft.TextField(
        ...
        value=propiedad_actual.numero_cuenta_administracion if propiedad_actual and propiedad_actual.numero_cuenta_administracion else "",
        width=250,
        prefix_icon=ft.Icons.ACCOUNT_BALANCE
    )
    ...
    txt_codigo_energia = ft.TextField(
        ...
        value=propiedad_actual.codigo_energia if propiedad_actual and propiedad_actual.codigo_energia else "",
        width=250,
    ...
    txt_codigo_agua = ft.TextField(
        ...
        value=propiedad_actual.codigo_agua if propiedad_actual and propiedad_actual.codigo_agua else "",
        width=250,
    ...
    txt_codigo_gas = ft.TextField(
        ...
        value=propiedad_actual.codigo_gas if propiedad_actual and propiedad_actual.codigo_gas else "",
        width=250,
    ...
    txt_observaciones = ft.TextField(
        ...
        value=propiedad_actual.observaciones_propiedad if propiedad_actual and propiedad_actual.observaciones_propiedad else "",
        multiline=True,
        min_lines=3,
        max_lines=5,
        expand=True
    ...
    def handle_guardar_click(e):
        ...
        try:
            ...
            traceback.print_exc()
            page.snack_bar = ft.SnackBar(
                ft.Text(f"Error inesperado: {err}"),
                bgcolor=colors.ERROR
            )
            page.snack_bar.open = True
            page.update()
    ...
    formulario = ft.Container(
        content=ft.Column(
            [
                ...
                ft.Container(
                    content=ft.Column([
                        ft.Text(f"Inicio > Propiedades > {'Editar' if es_edicion else 'Nueva'}", style=styles.breadcrumb_text()),
                        ft.Text(
                            titulo,
                            size=24,
                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ...
                            ft.Row(
                                [txt_matricula, txt_fecha_ingreso],
                                spacing=20
                            ),
                        ],
                        spacing=15
                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ...
                            ft.Row([txt_telefono_admin, dropdown_tipo_cuenta, txt_numero_cuenta], spacing=20),
                        ],
                        spacing=15
                    ),
                    padding=ft.padding.only(bottom=20)
                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ...
                            ft.Divider(height=1, color=colors.BORDER_DEFAULT),
                            ft.Row([txt_codigo_energia, txt_codigo_agua, txt_codigo_gas], spacing=20),
                        ],
                        spacing=15
                    ),
                    padding=ft.padding.only(bottom=20)

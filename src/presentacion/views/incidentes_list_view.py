...
class IncidentesListView(ft.Column):
    def __init__(
        self, page: ft.Page, servicio_incidentes: ServicioIncidentes, on_navigate: Callable
    ):
        ...
        self.contenedor_incidentes = ft.Row(
            wrap=True, spacing=20, alignment=ft.MainAxisAlignment.START, scroll=ft.ScrollMode.AUTO
        )
            ...
            ft.Container(
                content=ft.Column(
                    [
                        ...
                        # Data container
                        ft.Container(content=self.contenedor_incidentes, expand=True),
                    ]
                ),
                expand=True,
            ),
